...
class RouterTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testMatchesRouteRulesWithDefaultArguments ()
    {
        ...
        $router->mapRoute ("test", "{controller}/{action}/{id}/{subid}/{someid}", ['id' => 'default_id', 'subid' => 'default_subid', 'someid' => 'default_someid']);
    ...
    {
        $router = new Router(new DIContainer());
        $router->mapRoute ("test", "{controller}/{action}/{id}/{subid}/{someid}", ['action' => 'default_action', 'id' => 'default_id', 'subid' => 'default_subid', 'someid' => 'default_someid']);
    ...
    {
        $router = new Router(new DIContainer());
        $router->mapRoute ("test", "fixedPrefix/{action}/{id}/{subid}/{someid}", ['controller' => 'default_controller', 'id' => 'default_id', 'subid' => 'default_subid', 'someid' => 'default_someid']);
        ...
        $router = new Router(new DIContainer());
        $router->mapRoute ("test", "{controller}/{action}/{id}/{subid}/{someid}", ['controller' => 'default_controller', 'action' => 'default_action', 'id' => 'default_id', 'subid' => 'default_subid', 'someid' => 'default_someid']);
